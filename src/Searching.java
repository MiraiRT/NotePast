...
public class Searching {
    ...
    public static void addPeople(Searching book,PeopleTag people) {
        book.getStackOfPeopleTag().add(people);
    }

    public static void addLocation(Searching book,LocationTag place) {
        book.getStackOfLocationTag().add(place);
    }
}
